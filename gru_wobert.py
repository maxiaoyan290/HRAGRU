...
mymodelwobert = gru_model.testmodelwithoutbert(67).to(device)
...
optimizer = torch.optim.Adam(mymodelwobert.parameters(), lr=0.000164)
...
# torch.save(mymodel.state_dict(), 'model_state_dict_' + 'gru' + '.pth')
    if i == 100:
        torch.save(mymodelwobert.state_dict(), 'model_state_dict_' + 'wobert_gru_100' + '.pth')
    if i == 200:
        torch.save(mymodelwobert.state_dict(), 'model_state_dict_' + 'wobert_gru_200' + '.pth')
    if i == 300:
        torch.save(mymodelwobert.state_dict(), 'model_state_dict_' + 'wobert_gru_300' + '.pth')