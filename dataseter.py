...
class trainDataset():
    def __init__(self):
        ...
        for corporate in corporate_list:
            print(corporate)
            return_list, label_lists, news_list = self.get_Data(corporate)
            data_list, label_list, news_list = \
                self.slide_windows(return_list, label_lists, news_list)
            data = data + data_list
    ...
    def get_Data(self, corporate_name):
        ...
        return return_list, label_list, news_list

    def slide_windows(self, return_list, label_lists, news_lists):
        data = []
        label = []
        news = []
        ...
        return data, label, news

    def __getitem__(self, index):
        return self.data[index], self.label[index], self.new_data[index]
