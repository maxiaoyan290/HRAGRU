...
# 参数都得改
mymodelnew_100 = gru_model.StockLSTM(67, 64, 1, 2).to(device)
mymodelnew_200 = gru_model.StockLSTM(67, 64, 1, 2).to(device)
mymodelnew_300 = gru_model.StockLSTM(67, 64, 1, 2).to(device)
mymodelnew_400 = gru_model.StockLSTM(67, 64, 1, 2).to(device)
mymodelnew_500 = gru_model.StockLSTM(67, 64, 1, 2).to(device)

mymodelnew_100.load_state_dict(torch.load('model_state_dict_lstm_100.pth'))
mymodelnew_100.load_state_dict(torch.load('model_state_dict_lstm_200.pth'))
mymodelnew_100.load_state_dict(torch.load('model_state_dict_lstm_300.pth'))
mymodelnew_100.load_state_dict(torch.load('model_state_dict_lstm_400.pth'))
mymodelnew_100.load_state_dict(torch.load('model_state_dict_lstm_500.pth'))
...
for data, label, news, policy, wobert, wognn in dataloader:
    ...
    output_100 = mymodelnew_100(wobert)
    output_200 = mymodelnew_200(wobert)
    output_300 = mymodelnew_300(wobert)
    output_400 = mymodelnew_400(wobert)
    output_500 = mymodelnew_500(wobert)
    # print(output.shape)
    # print(output.shape)
    # print(output.shape)
