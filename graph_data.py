...
class trainDataset():
    def __init__(self):
        ...
        for corporate in corporate_list_0:
            print(corporate)
            graph_list, dict_list, label_list = self.get_Data(corporate)
            graph_data = graph_data + graph_list
            dict_data = dict_data + dict_list
    ...
    def get_Data(self, corporate_name):
        ...
        return graph_list, dict_list, label_list

    def __getitem__(self, index):
        return self.graph_data[index], self.dict_data[index], self.label[index]
